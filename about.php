...
?>
	<div class="container-fluid">	
		<div class="row">
			...
			<div class="col-sm-6 col-md-4"><img src="images/Banshee Tree.jpg"  class="img-responsive img-rounded" alt="Local swing band Banshee Tree, playing live on air in CCRN's studio, during Frozen Dead Guy Days 2015"></div>
		</div>
	</div>
    </div><!-- /.container-fluid -->
